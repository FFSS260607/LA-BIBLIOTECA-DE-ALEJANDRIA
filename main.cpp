...
// Normaliza una cadena para comparaciones independientes de mayusculas y acentos
...
// Parsea una linea de texto con formato de libro y crea un objeto Libro
...
// Maneja las areas no declaradas durante la importacion
...
// Procesa cada area del archivo de importacion y evita duplicados no deseados
...
// Importa estructuras de biblioteca desde un archivo .txt de datos
bool importarArchivoBiblioteca(Biblioteca& b, const string& nomArchivo, bool usarMetadata) {
    ...
    map<string, string> areasEnArchivo; 
...
// Lista los archivos de texto disponibles en la carpeta de recursos
...
// Pide al usuario seleccionar un archivo de texto para importar
...
// Busca libros por autor y titulo en todas las areas registradas
...
// Muestra resultados paginados y permite seleccionar un libro
...
// Menu del inventario con operaciones de prestamo, devolucion e importacion
...
// Punto de entrada del programa y menu inicial para iniciar o cargar biblioteca
int main() {
    ...
    while (opcionPrincipal != 0) {
        ...
        cout << "  2. Cargar una biblioteca desde un archivo (.txt)" << endl;
        ...
        if (opcionPrincipal == 1) {
            ...
            cout << "Desea importar areas o libros desde un archivo? (S/N): ";
